...
<div class="mx-auto max-w-7xl">
    <x-admin.page-header eyebrow="Catalog" title="Services" description="Control pricing, timing, descriptions, visibility, and ordering."><x-slot:actions><a class="brand-button px-5 py-3" style="--brand:#047857" href="{{ route('admin.services.create') }}">+ New service</a></x-slot:actions></x-admin.page-header>
    <div class="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        @forelse($services as $service)
            <div class="grid gap-4 border-b border-slate-100 px-6 py-5 last:border-0 lg:grid-cols-[1fr_150px_120px_auto] lg:items-center lg:px-8">
